  ...
  "shipping-returns": {
    en: {
      ...
      paragraphs: [
        ...
        "Warranty: every product is covered by the 2-year EU legal warranty. Defective items are repaired, replaced or refunded at no cost to you.",
      ],
    },
    es: {
      ...
      paragraphs: [
        ...
        "Garantía: todos los productos están cubiertos por la garantía legal europea de 2 años. Los artículos defectuosos se reparan, sustituyen o reembolsan sin coste.",
      ],
    },
    nl: {
      ...
      paragraphs: [
        ...
        "Garantie: elk product valt onder de wettelijke EU-garantie van 2 jaar.",
      ],
    },
    de: {
      ...
      paragraphs: [
        ...
        "Garantie: 2 Jahre gesetzliche EU-Gewährleistung auf jedes Produkt.",
      ],
    },
    fr: {
      ...
      paragraphs: [
        ...
        "Garantie : chaque produit est couvert par la garantie légale européenne de 2 ans.",
      ],
    },
    it: {
      ...
      paragraphs: [
        ...
        "Garanzia: ogni prodotto è coperto dalla garanzia legale europea di 2 anni.",
      ],
    },
  },
};
